...
public final class ConflictException extends DomainException {
    public ConflictException(String message, ErrorCode code, ErrorContext context) {
        super(message, null, code, Severity.MEDIUM, Retryability.IDEMPOTENT_RETRY, context, java.util.Map.of());
    }
}
